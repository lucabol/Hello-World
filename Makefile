...
# Test target - run unit tests for output validation
test: test_output.sh
	./test_output.sh

# Build and run the program (simple test)
run: $(TARGET)
	./$(TARGET)
...
help:
	...
	@echo "  test       - Run unit tests for output validation"
	@echo "  run        - Build and run the program"
	@echo "  clean      - Remove all compiled binaries"
	@echo "  help       - Show this help message"

# Declare phony targets
.PHONY: all dev optimized strict debug clean test run help