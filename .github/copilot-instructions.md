...
2. Execute `./test/validate.sh` which validates:
   ...
   - Program outputs "Hello world!" with a trailing newline
...
3. **Verify output:** `Hello world!` with a trailing newline
...
**Output:** "Hello world!" with a trailing newline (exit code 0)
...
- **Validate output format:** Must output "Hello world!" with a trailing newline
